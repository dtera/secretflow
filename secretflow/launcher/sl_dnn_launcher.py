...
def create_base_model_alice():
    ...
    def create_model():
        ...
        def preprocess():
            ...
            outputs = [user_id_output(inputs["UserID"]),
...
def create_base_model_bob():
    ...
    def create_model():
        ...
        def preprocess():
            ...
            outputs = [movie_id_out(inputs["MovieID"]),
...
def create_fuse_model():
    ...
    def create_model():
        ...
        model = DnnFuse(input_shapes=[128, 32], dnn_units_size=[256, 256, 32],
                        dnn_units_activation=["relu", "relu", "relu"])
        model.compile(
            loss=tf.keras.losses.binary_crossentropy,
            optimizer=tf.keras.optimizers.Adam(),
            metrics=[
